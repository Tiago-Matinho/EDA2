...
void air_read(FILE* air_file, FILE* flight_list_file, struct air_hash* air_hash, char airport[AIRPORT]){
    if(air_file == NULL){
    ...
    dep_list_read(flight_list_file, new_airport->fly_list, key);
